...
var FACS = [
  ...
  [
    "Southern Maine Recovery",
    "Westbrook, ME",
    "New England",
    "Residential Supportive Housing",
    true,
    "Guardian Recovery - Southern Maine Recovery",
  ],
  [
    "CuraWest",
    "Denver, CO",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ fontSize: 14, fontWeight: 600, color: C.mid }}>
            {props.title}
          </div>
          <button
            onClick={props.onClose}
            ...
            onError={function (e) {
              ...
              e.target.parentNode.insertAdjacentHTML(
                ...
                "<div style='padding:40px 20px;color:" +
                  C.bat +
                  ";font-size:12px;'>Preview image not yet available.<br/>Expected: " +
                  imgPath +
                  "</div>",
              );
            }}
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "14px 18px" }}>
        ...
        <div style={{ fontSize: 12, color: C.cav, lineHeight: 1.6 }}>
          {props.children}
        </div>
      </div>
    </div>
    ...
    >
      ...
      >
        <img
          ...
          alt=""
          style={{ width: 22, height: 11, flexShrink: 0 }}
        />
...
function CollateralNav(props) {
  ...
  return (
    <div>
      ...
      {cur.sub ? (
        <SubCollateral key={cat} items={cur.sub} ac={cur.ac} />
      ) : (
        <Row gap={10}>
          {COLLATERAL_TYPES.map(function (t) {
  ...
  if (!unlocked)
    return (
      ...
      >
        ...
        <div style={{ fontSize: 12, color: C.bat, marginBottom: 20 }}>
    ...
    return (
      <div style={st}>
        ...
        >
          ...
          >
            <span style={{ fontSize: 13 }}>↓</span> PDF Version
          </a>
          <a
            href={GUIDE_MD || "#"}
            download
          ...
          >
            <span style={{ fontSize: 13 }}>↓</span> Markdown Version
          </a>
        </div>
      </div>
    );
      ...
      >
        ...
        <Sec id="story" pn="I" t="Brand Story and Positioning">
          ...
          <P>
            ...
            every piece of content, and every interaction with a Guest or their
            family.
          </P>
          ...
          <Cd t="Compassion First">
            ...
            to long-term aftercare. Every Guest, every family member, every
          ...
          >
            ...
            >
              <div style={{ fontSize: 12, color: C.cad, lineHeight: 1.7 }}>
                Three words that do everything a tagline should.{" "}
                <span style={{ color: C.fro, fontWeight: 500 }}>"Hope"</span>{" "}
                names the emotional state every Guest, family member, and
          ...
          <P>
            Each service line signature completes "Freedom to" with the single
            most resonant word for its audience. "Freedom" captures what every
            Guest seeks: liberation from the condition controlling their life.
          </P>
          <Cd ac={C.cer} t="Adult SUD" sub="Freedom to live.">
            For someone in the grip of addiction, life has stopped.
            Relationships, careers, health, joy — all suspended or destroyed.
            "Live" cuts straight to the core of what recovery restores. Simple,
            direct, and complete — it is both the loss and the promise in a
            single word.
          </Cd>
          <Cd ac={C.pac} t="Adult Mental Health" sub="Freedom to feel.">
            The mental health audience isn't dying — they're muted. Anxiety
            narrows attention, depression flattens emotional range, trauma walls
            off parts of themselves. "Feel" names exactly what these conditions
            take away and what treatment restores: the full, unguarded
            experience of being alive.
          </Cd>
          <Cd ac={C.sag} t="Adolescent" sub="Freedom to grow.">
            Growth is the defining task of adolescence. When substance use or
            mental health challenges intervene, that growth stalls —
            emotionally, socially, academically, developmentally. "Grow" names
            what treatment restores: the natural trajectory of a young person's
            life.
          </Cd>
          ...
          <P mu={true}>
            Service line signatures pair with "Hope Starts Here." only. They do
            not pair with the BD or internal lines.
          </P>
        ...
        <Sec id="voice" pn="I" t="Brand Voice and Messaging">
          ...
          <Cd t="Inclusive, not generic">
            ...
            feel welcoming to all Guests without resorting to hollow diversity
            statements.
          </Cd>
          ...
          <Tb
            ...
            r={[
              ...
              [
                ...
                "Every Guest we welcome. That's why we're here.",
              ],
            ]}
          />

          <H3>The "Guest" standard</H3>
          <P>
            Effective with these guidelines, Guardian Recovery refers to all
            individuals receiving care as "Guests." This reflects our belief
            that every person deserves the dignity and hospitality you'd extend
            to a guest in your own home.
          </P>
          <Tb
            h={["Context", "Term"]}
            r={[
              ["All external communications", "Guest / Guests"],
              ["Internal communications", "Guest / Guests"],
              [
                "Clinical documentation",
                "Patient / Client (regulatory compliance)",
              ],
              ["Marketing copy on clinical topics", "Guest"],
              ["Third-party / media", "Guest"],
            ]}
          />
          <P it={true}>
          ...
          <Tb
            ...
            r={[
              [
                "Guest",
                "Patient, client (in marketing)",
                "Hospitality-centered model",
              ],
              [
          ...
          <P>
            <span style={{ fontWeight: 600 }}>HIPAA.</span> No Guest names,
        ...
        <Sec id="arch" pn="I" t="Brand Architecture">
          ...
          />
          <P mu={true}>
            *GR - Southern Maine Recovery is not a clinical facility.
          ...
          <Cd t="Long (100+ words)">
            ...
            three distinct service lines ensure that every Guest receives care
          ...
          <Cd t="Medium (50-75 words)">
            ...
            built around each Guest's unique needs. guardianrecovery.com
          </Cd>
        ...
        <Sec id="svc" pn="I" t="Service Lines and Specialty Programs">
          ...
          <P>
            ...
            reintegration. Intensive examination of barriers to recovery. Guests
        ...
        <Sec id="logo" pn="II" t="Logos and Facility Lockups">
          ...
          <LogoGrid
            items={[
              ...
              ["Southern Maine Recovery", null, null, "logo-smr"],
            ]}
          />
              ...
              return (
                ...
                >
                  ...
                  <div style={{ padding: "14px 16px" }}>
                    ...
                    <div
                      style={{ fontSize: 12, color: C.cav, lineHeight: 1.6 }}
                    >
                      {s.evoke}
                    </div>
                  </div>
              ...
              >
                {[
                  ...
                  return (
                    <div
                      key={w[0]}
                      style={{ fontSize: 12, fontWeight: w[1], color: C.cav }}
                    >
                      {w[0]}
                    </div>
                  );
          ...
          >
            {[
              ...
              [
                ...
                null,
                400,
                "We build personalized treatment plans that honor each Guest's unique history, goals, and circumstances.",
        ...
        <Sec id="photo" pn="II" t="Photography and Imagery">
          ...
          <Tb
            h={["Never", "Why"]}
            r={[
              ["Guest images without documented consent", "HIPAA compliance"],
              [
        ...
        <Sec id="gfx" pn="II" t="Graphic Elements and Patterns">
          ...
          >
            ...
            />
            <div style={{ fontSize: 12, color: C.cav }}>
        ...
        <Sec id="dig" pn="III" t="Digital Standards">
          ...
          <Tb
            ...
            r={[
              ...
              ["Body copy", "IBM Plex Sans Regular, 14–16px, Eerie on white"],
              [
                "Primary CTA",
          ...
          <P mu={true}>
            Rules: No Guest-identifiable content without consent. No stock
          ...
          <P>
            ...
            white. Body: IBM Plex Sans 14–16px, Eerie on white. Headlines: DM
          ...
          <Cd t="Tone and music">
            ...
            Guests on camera without documented consent.
          </Cd>
        ...
        <Sec id="print" pn="III" t="Print and Collateral">
          ...
          <P>
            Warmest in the system. DM Serif Text headers, 14pt minimum, warm
            photography.
          </P>
          <P mu={true}>
